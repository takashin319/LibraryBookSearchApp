...
class LibrarySearchViewModel(
    ...
    private val _getLibraryDataRepository = GetLibraryDataRepository()
    ...
    fun getLibraryData() {
        viewModelScope.launch {
            libraryList.value = _getLibraryDataRepository.getLibraryList(selectPref, selectCity)
        }
    }
...
//    }
    ...
    fun prefList(area: String): List<String> {
        val prefList =
            when (area) {
                "北海道・東北" -> {
                    listOf(
    ...
    fun cityList(pref: String): List<String> {
        val cityList =
            when (pref) {
                "北海道" -> {
                    listOf(
